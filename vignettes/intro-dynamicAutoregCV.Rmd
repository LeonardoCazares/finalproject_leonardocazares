...
df_plot <- data.frame(
  date = train_test_data$dates_test,
  real = train_test_data$x_test,
  pred = forecasting
)

ggplot(df_plot, aes(x = date)) +
  geom_line(aes(y = real), color = "black") +   # serie real
  geom_line(aes(y = pred), color = "red") +     # predicciones
  labs(title = paste("Temperature forecasting in Austin, ",initial_test_date,'-',final_test_date),
       x = "Date",
       y = "Temperature (°F)") +
  theme_minimal()
```

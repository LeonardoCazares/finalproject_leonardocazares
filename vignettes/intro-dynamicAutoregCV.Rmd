...
Below we can appreciate the behavior of the ground-truth and the forecasting given by the dynamic autoregressive model with ridge regularization.
...
ggplot(df_plot, aes(x = date, y = value, color = serie)) +
  ...
  labs(title = paste('Temperature Forecasting in Austin, TX. ',initial_test_date,' - ',final_test_date),
       x = "Date",
       y = "Temperature (°F)",
       color = "Time serie:") +
  theme_minimal()

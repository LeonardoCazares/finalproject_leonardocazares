...
At this point we have the optimized regularization parameter and the number of lags, from this point forward we create the predictions with dinamic training
...
rmse <- mean((as.numeric(forecasting$y_pred) - as.numeric(train_test_data$x_test))**2)
print(rmse)
```

...
To acomplish the two features mentioned above we implemented we prepared a dataset of average daily temperature in Austin, TX (extracted from the National Centers for Environmental Information (NCEI)). The dataset covers the period from 2016-01-01 to 2025-08-25, with measurements in °F. 

Providing some functions, data spliting into training and testing sets that is 
